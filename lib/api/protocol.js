module.exports = function(Nightwatch) {
  ...
  /**
   * Touch-clicks at the specified element
   *
   * @link /session/:sessionId/touch/click
   * @param {string} element Opaque ID assigned to the element to move to.
   * @param {function} callback
   * @api protocol
   */
   Actions.elementIdTouchClick = function(id, callback) {
    return postRequest('/element/' + id + '/touch/click', '', callback);
  };
